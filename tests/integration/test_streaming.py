...
class TestStreamingEndpoint:
    ...
    def test_streaming_events_order(self, mock_orchestrator_class, client, admin_token):
    ...
    @patch('src.api.routes.reasoning.MockReasoningOrchestrator')
    @pytest.mark.skip(reason="Covered by test_reasoning_endpoint.py")
    def test_streaming_headers(self, mock_orchestrator_class, client, admin_token):
    ...
    @patch('src.api.routes.reasoning.MockReasoningOrchestrator')
    @pytest.mark.skip(reason="Covered by test_reasoning_endpoint.py")
    def test_streaming_without_thinking(self, mock_orchestrator_class, client, admin_token):
    ...
    @patch('src.api.routes.reasoning.MockReasoningOrchestrator')
    @pytest.mark.skip(reason="Covered by test_reasoning_endpoint.py")
    def test_streaming_multiple_tool_calls(self, mock_orchestrator_class, client, admin_token):
